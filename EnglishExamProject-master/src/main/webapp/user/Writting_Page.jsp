...
<div class="container" style="margin: 80px auto;">
    <div class="col-xs-12" style="height: 700px;">
        <div style="margin: 20px 0;">
            <ul>
                <c:forEach items="${writting_pageList}" var="writting_pageList">
                    <li style="margin-bottom: 20px;background-color:#f7f7f7;padding:10px 10px;">
					  	    <span>
					  		    <p style="font-size: 20px;">${writting_pageList.writting_pageName}</p>
					  	    </span>
                        <span>摘要: ${writting_pageList.writting_pageSummary }....</span>
                        <br>
                        <br>
					  	    <span>
                                <a href="/user/writting/WrittingExam.do?writting_pageId=${writting_pageList.writting_pageId}">开始训练</a>&nbsp;&nbsp;
					  	    </span>
                    </li>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#pre').attr('href','/user/writting/listWritting_Page.do?page='+pre)
        for (var i = 0; i < pageTotal; i++) {
            ...
            $('#current'+(i+1)).attr('href','/user/writting/listWritting_Page.do?page='+(i+1))
            if ((i+1)==currentPage) {
        ...
        $('#next').attr('href','/user/writting/listWritting_Page.do?page='+next);
        if (pageTotal==1){

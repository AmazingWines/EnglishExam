    ...
    <div class="col-sm-12" style="height: 750px;">
        ...
        <div class="col-sm-1" style="border: solid 1px #f7f7f7;background-color: #eaeaea;height: 750px;padding: 0 0;">
            <div class="col-sm-12" style="border: solid 1px #f7f7f7;background-color: #eaeaea;height: 120px;padding: 50% 5%;">
                <a class="btn btn-primary" onclick="WrittingExamDo()"><span class="glyphicon glyphicon-globe" style="font-size: 0px;"></span>查看范文</a>
            </div>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        $.ajax({
            type:'post',
            url:'/user/writting/WrittingDoExam.do?writting_pageId='+writting_pageId,
            data:params,
            async: false,
    ...
    function WrittingExamDo() {
        $.ajax({
            type:'post',
            url:'/user/writting/ajaxWritting.do?writting_pageId='+writting_pageId,
            success:function (data) {
                $("#WrittingMain").append('<div class="col-sm-12" id="mainWrittingDo" style="margin-top: 50px;background-color: #eaeaea;height: 280px;padding: 20px 20px;"> </div>')
                $("#mainWrittingDo").append('<div id="writtingtitle" class="col-sm-12" style="text-align: center; font-size:25px;"></div>')
                $("#writtingtitle").html(data.writtingCorrectTitle);
                $("#mainWrittingDo").append('<div id="writtingwrite"></div>')
                $("#writtingwrite").html(data.writtingCorrect)
            }
        });
    }

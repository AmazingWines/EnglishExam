    ...
    <div class="container" style="margin: 80px auto;">
        <div class="col-xs-12" style="height: 700px;">
            <div style="margin: 20px 0;">
                <ul>
                    <c:forEach items="${listen_pages}" var="listen_pages">
                    <li style="margin-bottom: 20px;background-color:#f7f7f7;padding:10px 10px;">
					  	    <span>
					  		    <p style="font-size: 20px;">${listen_pages.listen_pageName}</p>
					  	    </span>
                        <span>摘要: ${listen_pages.listen_summary }....</span>
                        <br>
                        <br>
					  	    <span>
                                <a href="/user/gotoExam.do?listen_pageId=${listen_pages.listen_pageId}&page=1">开始训练</a>&nbsp;&nbsp;
					  	    </span>
                    </li>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#pre').attr('href','/user/listListen_page.do?page='+pre)
        for (var i = 0; i < pageTotal; i++) {
            ...
            $('#current'+(i+1)).attr('href','/user/listListen_page.do?page='+(i+1))
            if ((i+1)==currentPage) {
        ...
        $('#next').attr('href','/user/listListen_page.do?page='+next);
        if (pageTotal==1){
